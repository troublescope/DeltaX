...
from bot.helper.ext_utils.fs_utils import (check_storage_threshold,
                                           get_base_name)
from bot.helper.mirror_utils.status_utils.gd_download_status import \
    GdDownloadStatus
...
def add_gd_download(
        ...
        if gname is not None:
            ...
            if gmsg:
                ...
                if tegr:
                    ...
                    return sendMessage(gmsg, listener.bot, listener.message, button)
    ...
    if (
        any([ZIP_UNZIP_LIMIT, STORAGE_THRESHOLD, TORRENT_DIRECT_LIMIT, LEECH_LIMIT])
